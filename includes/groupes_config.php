    ...
    return [
        ...
        'STOCK' => [
            ...
            'nav' => [
                ...
                ['label'=>'Réception de site', 'icon'=>'ph-inbox',
                 'url'=>'pages/reception_site.php','active_keys'=>['reception_site'],
                 'roles_include'=>['gestionnaire_stock','admin','superadmin','superviseur_operation']],
